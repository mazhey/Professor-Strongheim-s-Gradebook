...
/**
 * Servlet implementation class AssignmentbyStudentType
 */
@WebServlet("/AssignmentbyStudentType")
public class AssignmentbyStudentType extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AssignmentbyStudentType() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		out.println("<div class=\"panel-heading\" style=\"font-weight: bold;\">Assignment by Student by Type</div>");
		...
		try {
			...
			String sql="select * from GRADEBOOK where student_id= ? and ASSIGNMENT_TYPE=?";
		     PreparedStatement preStatement=conn.prepareStatement(sql);
		     preStatement.setString(1, studentid);
		     preStatement.setString(2,assignmenttpe ); 
