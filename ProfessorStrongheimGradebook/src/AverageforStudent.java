...
/**
 * Servlet implementation class AverageforStudent
 */
@WebServlet("/AverageforStudent")
public class AverageforStudent extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AverageforStudent() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		out.println("<div class=\"panel-heading\" style=\"font-weight: bold;\">Average for Student</div>");
		out.println("<div class=\"panel-body\">");
		String studentid=request.getParameter("studentid");
		try {
			Connection conn = UtilitiesDB.getConnection();
			String sql="select  STUDENT_ID, AVG(grade) as gradeAverage from GRADEBOOK where STUDENT_ID=? group by STUDENT_ID";
